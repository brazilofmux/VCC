 ...
 *
 * Lifted from ~/z80/dbt/emit_a64.h (itself from ~/riscv/dbt) — same
 * single-header static-inline style, same author. The VCC Level-1/2
 * backend uses a subset; unused encoders cost nothing in a header.
 *
 * Host register convention used by BlockJitA64.cpp:
 *   X19 = &cpu_state (Hd6309State base)  (callee-saved)
 *   X20 = &slot.insns[0]                 (callee-saved)
 *   X16, W1 = scratch
 *
